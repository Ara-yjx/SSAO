...
void Shader::updateShader(ShaderArg* arg = nullptr) {
    ...
    glUniform1i(glGetUniformLocation(filterShader, "ssaoSwitch"), arg->switchState1 ? 1 : 0);
    glUniform1i(glGetUniformLocation(filterShader, "filterSwitch"), arg->switchState2 ? 1 : 0);
